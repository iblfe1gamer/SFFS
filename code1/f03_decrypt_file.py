...
def decryptFile(
    ...
    # SFFS header is 77 bytes:
    #   Magic (4) + Version (1) + IV (16) + Auth Tag (16) + Hash (32) + Size (8) = 77
    HEADER_SIZE = 4 + 1 + 16 + 16 + 32 + 8  # = 77
    ...
    try:
        ...
        if output_dir is not None:
            output_path = output_dir / sffs_path.name[:-5]  # Remove .sffs suffix
    ...
    output_path = output_dir / sffs_path.name[:-5]  # Remove .sffs extension
